...
def process_protein(prot_string):
    ...
    return {id_prot:{"Name":prot_name, "Description":process_de(de_arr), "Isoform":create_iso(isostring), "SV":sv_int, "PE":pe_val, "Gene":gene_arr, "DB":db_name, "Chembl_id":chembl_id, "Organism": os, "Prev_ids":extra_id_arr}}
